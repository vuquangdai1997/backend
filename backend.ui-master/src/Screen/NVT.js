...
import Data from '../Component/NVT/Data';
export default function NVT() {
    ...
    const Handler_OnClick = (event,data) => {
        event.preventDefault();
        SetState({type:"NVTSTT",payload:data});
    }
            ...
            <div className="navbar-inner mt-5">
              ...
              <div className="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="./nhanvien/nhanvien.html" onClick={(event)=>Handler_OnClick(event,1)}>
                      ...
                      <span className="nav-link-text">Chi Nhánh</span>
                    </a>
                  </li>
                  <li className="nav-item">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="./QL_chitieu/qlthuchi.html" onClick={(event)=>Handler_OnClick(event,3)}>
                      <i className="ni ni-single-02 text-yellow" />
                      <span className="nav-link-text">Kho</span>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="./QL_chitieu/qlthuchi.html" onClick={(event)=>Handler_OnClick(event,4)}>
                      <i className="ni ni-single-02 text-yellow" />
                      <span className="nav-link-text">Nhà Cung Cấp</span>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="./QL_chitieu/qlthuchi.html" onClick={(event)=>Handler_OnClick(event,5)}>
                      <i className="ni ni-single-02 text-yellow" />
                ...
                <li className="nav-item ">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="./QL_chitieu/qlthuchi.html" onClick={(event)=>Handler_OnClick(event,6)}>
                      <i className="ni ni-single-02 text-yellow" />
                      <span className="nav-link-text">Hóa Đơn</span>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="./QL_chitieu/qlthuchi.html" onClick={(event)=>Handler_OnClick(event,7)}>
                      <i className="ni ni-single-02 text-yellow" />
