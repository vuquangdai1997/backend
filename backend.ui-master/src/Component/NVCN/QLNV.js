        ...
        <form>
          <table className="tablesuanhanvien">
            <tbody><tr>
              ...
              <tr>
                <th>CCCD </th>
                <td><input className="form-control" type="text" name="cmnd" onChange={(event)=>Handler_Onchange(event)} onKeyPress={(event)=>Handler.Number(event)}id="diem" /></td>
              </tr>
              <tr>
                <th>SĐT </th>
                <td><input className="form-control" type="text" name="sdt" onChange={(event)=>Handler_Onchange(event)} onKeyPress={(event)=>Handler.Number(event)} id="diem" /></td>
              </tr>
              <tr>
                <th>Địa chỉ </th>
